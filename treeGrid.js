...
layui.config({
    ...
    Class.prototype.treeIconRender=function (o,isHtml) {
        var that = this
            ...
            ,isTreeNode=(o.children&&o.children.length>0) || (o.state==0);
        var temTreeHtml='';
        if(iconOpen){
            ...
            if(isTreeNode){//父节点
                if((o[table.config.cols.iconOpen]||o[table.config.cols.iconClose])){
                    ...
                    temTreeHtml='<i class="layui-icon layui-tree-'+o[options.idField]+' layui-tree-'+ (o[table.config.cols.isOpen] ? "branch" : "branch") +'" '+iconOpen+'>'+(o[table.config.cols.isOpen]?that.config.branch[1]:that.config.branch[0])+'</i>';
                }
            }else{//叶子节点
                    ...
                    /*var temf=function (o) {
                        ...
                        if(o&&o.children.length>0){
                            ...
                            if(temis){
                                ...
                                that.setCheckData(o[table.config.indexName], false);
                            }
